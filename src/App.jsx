  ...
  return (
    <main className="relative bg-stone-50 text-neutral-900 min-h-screen flex flex-col overflow-hidden">
      ...
      <footer className="relative z-10 mx-auto max-w-7xl px-6 pb-6 text-center text-xs text-neutral-900">
        <div className="inline-flex items-center gap-4 bg-white/60 backdrop-blur-sm px-4 py-3 rounded-lg">
          <span>© {new Date().getFullYear()} Synaptik Core</span>
          <span className="text-neutral-400">•</span>
          <a
            href="https://www.linkedin.com/company/synaptik-core/"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 text-neutral-700 hover:text-indigo-600 transition-colors"
            aria-label="Follow Synaptik Core on LinkedIn"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
