  ...
  return (
    <main className="relative bg-stone-50 text-neutral-900 min-h-screen flex flex-col overflow-hidden">
      ...
      <img
        ...
        alt=""
        aria-hidden="true"
        className="pointer-events-none select-none absolute top-0 right-0 z-0 w-[85vw] max-w-[740px] h-auto"
        loading="eager"
      />
      {/* CONTENT LAYOUT */}
      <section className="relative z-10 mx-auto flex flex-1 w-full max-w-7xl flex-col md:flex-row items-center justify-between pl-2 pr-6  py-20">
      ...
      <button
        ...
        className="fixed bottom-0 right-10 z-40 relative h-12 w-12 items-center justify-center text-neutral-900 hover:text-neutral-700"
      >
        <svg
        ...
        {open && (
          <div
            className="fixed bottom-0 right-10 z-20 border-t border-l border-r border-neutral-900 bg-neutral-900 p-6 w-[360px] h-[280px] space-y-4 overflow-auto"
          >
            <a
